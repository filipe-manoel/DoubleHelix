#' Plot and save a heterogeneous power matrix with dimension equals to n
#'
...
#' @export
#'
#' @examples plot_power_het(n=5, rho = 0.7, save_path = "plot.png", width = 8, height = 8, dpi = 300)

#'
plot_power_het = function(n = 5, rho = 0.7, save_path = NULL, width = 5, height = 5, dpi = 300) {
  ...
  mat = outer(1:n, 1:n, function(i,j) rho^(abs(i-j))); diag(mat) = seq(1, n)
  df = reshape2::melt(mat)
  p = base_cartoon_plot(df, paste0("Power Het (", n + 1, " params)"))
