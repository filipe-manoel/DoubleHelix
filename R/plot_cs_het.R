#' Plot and save a heterogeneous compound simetry matrix with dimension equals to n
#'
...
#' @export
#'
#' @examples plot_cs_het(n=5, save_path = 'plot.png', width = 8, height = 8, dpi = 300)

#'
plot_cs_het = function(n = 5, rho= 0.5, save_path = NULL, width = 5, height = 5,
  dpi = 300) {

  # Definition of the structure

  mat = matrix(rho, n, n) + diag(1 - rho, n)
  diag(mat) = rnorm(n, mean = 0.6, sd= 0.39)
  ...
  p = base_cartoon_plot(df, paste0("CS Het (", n + 1, " params)"))
